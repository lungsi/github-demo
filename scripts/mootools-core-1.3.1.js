...
packager build:
 - packager build Core/Class.Extras Core/Element.Dimensions Core/DOMReady
...
}}this.$exec=p.exec;}).call(this);(function(){var k,n,l,g,a={},c={},m=/\\/g;var e=function(q,p){if(q==null){return null;}if(q.Slick===true){return q;}q=(""+q).replace(/^\s+|\s+$/g,"");
...
},getTop:function(){return this.getPosition().y;},getLeft:function(){return this.getPosition().x;}});(function(){var a=Object.prototype.hasOwnProperty;
...
Element.Events=new Hash(Element.Events);}).call(this);(function(j,l){var m,g,f=[],c,b,n=true;try{n=j.frameElement!=null;}catch(i){}var h=function(){clearTimeout(b);
